			...
			{user == null ? (
				<div className="default-header-content">
					<div className="links-div">
						...
						<div className="div-pages">
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/medic/dashboard")}>
								Dashboard
							</button>
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/medic/consultas")}>
								Consultas
							</button>
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/medic/mensagens")}>
								Conversas
							</button>
						</div>
					</div>
				...
				<div className="default-header-content">
					<div className="links-div">
						...
						<div className="div-pages">
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/dashboard")}>
								Dashboard
							</button>
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/consultas")}>
								Consultas
							</button>
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/mensagens")}>
								Conversas
							</button>
							<button className="default-button-page" disabled={disabled} onClick={() => loadNavigate("/medics")}>
								Médicos
							</button>
						</div>
					</div>
